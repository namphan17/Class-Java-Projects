...
public class nphan17_UnoPlayer implements UnoPlayer {
	...
	public int play(List<Card> hand, Card upCard, Color calledColor,
		...
		/*
		 * This strategy is very simple since I just play the color that I have
		 * most if I can. I only play the Wild card if I have to. I tried a
		 * couple more complicated strats like when to play the zero cards,
		 * associating with the numbers of cards in our hand, but for some
		 * reasons they can not exceed this strat. Therefore I just use this one
